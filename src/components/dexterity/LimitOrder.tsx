...
export const PlaceLimitOrder: FC = () => {
    ...
    const handlePlaceOrder = useCallback(async () => {
        ...
        const referralTrg = network == 'devnet' ? process.env.NEXT_PUBLIC_DEVNET_REFERRAL_TRG_DEVNET! : process.env.NEXT_PUBLIC_DEVNET_REFERRAL_TRG_MAINNET!
        ...
        try {
            ...
            const updateMarkIx = trader.getUpdateMarkPricesIx(products);
                ...
                // Submit the bulded instructions
            ...
            setIsSuccess(false);
            notify({ type: 'error', message: 'Placeing order failed!', description: error?.message });
            console.error(error)
        }   finally {
